...
const AboutPage = () => {
    return (
        <div id="root">
            <div id="back">
                <h1><p>About Vivekanand College</p></h1>
                ...
                <hr/>
                 <ul>
                    ...
                    <li>To cultivate a diverse and inclusive learning environment.</li>                        <li>To instill strong ethical values and leadership qualities.</li>
                </ul>
